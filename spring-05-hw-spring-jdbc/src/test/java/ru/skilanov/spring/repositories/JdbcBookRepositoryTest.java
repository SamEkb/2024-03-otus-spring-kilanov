...
class JdbcBookRepositoryTest {
    ...
    void shouldSaveNewBook() {
        var expectedBook = new Book(0, "Book_" + ID, dbAuthors.get(0), dbGenres.get(0));
    ...
    void shouldSaveUpdatedBook() {
        var expectedBook = new Book(ID, "Book" + ID, dbAuthors.get(2), dbGenres.get(2));
    ...
    void shouldDeleteBook() {
        assertThat(repositoryJdbc.findById(ID)).isPresent();
        repositoryJdbc.deleteById(ID);
        assertThat(repositoryJdbc.findById(ID)).isEmpty();
    }
